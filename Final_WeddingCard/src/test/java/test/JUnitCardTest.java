...
public class JUnitCardTest {
	...
	public void jUnitTest() throws IOException {
		...
		SqlSessionFactory facotry = new SqlSessionFactoryBuilder()
				.build(reader);
		...
		CardVO cvo = new CardVO(1, "무료", "", "예식장", "강남", "37-222", "11-222",
				"444-444", mvo, pvo, "example1");
		CardVO cvo2 = new CardVO(0, "무료2", "", "예식장", "강남", "37-222", "11-222",
				"444-444", mvo, pvo, "example2");
		CardVO cvo3 = new CardVO(0, "공짜", "", "ㅋㅋㅋ예식장", "강남", "37-222",
				"11-222", "444-444", mvo, pvo, "example3");

		// / ============== insert ============================
		System.out.println("card 추가");

		System.out.println("insert::"
				+ session.insert("cardSql.createCard", cvo3));
		session.commit();
		...
		System.out.println("update::"
				+ session.update("cardSql.modifyCard", cvo2));
		session.commit();
		...
		System.out.println("card 삭제::"
				+ session.delete("cardSql.deleteCard", 4));
		session.commit();
